...
{
    public class SalesSystemTestsBase : AbpIntegratedTestBase<SalesSystemTestsModule>
    {
        protected SalesSystemTestsBase()
        {
            UsingDbContext(context =>
            {
                new InitialHostDbBuilder(context).Create();             
                LogHelper.Logger.Log(LogSeverity.Debug, context.ToString);
            });
        }
