...
namespace Jeuci.SalesSystem.Api.Controllers
{
    public class SalesRecordController : ApiController
    {
        ...
        [HttpGet]
        public BootstrapTablePagedResult<SalesRecordOutput> GetList([FromUri] SalesRecordSearchInput searchInput)
        {
            var recordList = _saleSoftwareAppService.GetSalesServiceRecordPageList(searchInput);
            return recordList;
        }
